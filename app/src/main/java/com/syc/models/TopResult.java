...
public class TopResult implements Serializable
{
    ...
    @Expose
    private List<TopMultimedium> multimedia = null;
    @SerializedName("short_url")
    @Expose
    private String shortUrl;
    private final static long serialVersionUID = 6724174816001023010L;
    ...
    public String getMaterialTypeFacet() { return materialTypeFacet; }
    ...
    public List<TopMultimedium> getMultimedia() { return multimedia;  }
    public void setMultimedia(List<TopMultimedium> multimedia) { this.multimedia = multimedia;}
