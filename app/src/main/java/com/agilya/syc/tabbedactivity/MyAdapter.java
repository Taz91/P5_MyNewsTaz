...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType ) {
        ...
        View viewCell = inflater.inflate(R.layout.list_item, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        private final TextView monParam1 ;
        private final TextView monParam2 ;
        private Pair<String,String> curData;

        public MyViewHolder(final View itemView){
            super(itemView);
            monParam1 = ((TextView) itemView.findViewById(R.id.param1));
            monParam2 = ((TextView) itemView.findViewById(R.id.param2));
        }
